...
const App = () => {
  return (
    <div className="flex p-10 flex-col h-screen items-center w-full justify-center space-y-20 font-dmsans tracking-widest font-semibold bg-light-gray text-dark-gray">
